...
;; The list of column names in the current table.
...
;; See elisp-completion-at-point. TODO: need to work out how to trigger autocomplete. Also need to figure out why we make Emacs unresponsive when there is an error in the SQL we enter
